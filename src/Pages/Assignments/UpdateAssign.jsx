...
const UpdateAssign = () => {
    ...
    const handleUpdateAssignment = (e)=>{
        ...
        fetch(`https://assaignment-11-server-beige.vercel.app/assignments/${loadedUser._id}`,{
            method: 'PUT',
            headers: {
        ...
        .then(data => {
            ...
            if(data.modifiedCount>0){
                toast.success('Assignment is Updated Successfully!!')
            }
        })
    }
    return (
            ...
            <form onSubmit={handleUpdateAssignment}>
                <div className="flex justify-center items-center flex-col bg-gradient-to-b from-white to-violet-300 pb-5">                   
                    <div className="text-center pt-6">
                        ...
                        <h1 className="lg:text-4xl md:text-4xl text-3xl font-semibold text-violet-600 pb-5 pt-5">Update Assignment</h1>
                    ...
                    <div className="flex gap-5 flex-col justify-center">
                        ...
                        <div className="form-control">
                            ...
                            <label className="">
                                <input 
                                    ...
                                    defaultValue={loadedUser.imgURL}
                                    className="input lg:w-96 md:w-96 w-auto rounded-sm bordered border-violet-300" 
                        ...
                        {/* onBlur={(e)=>setDifficulty(e.target.value)} */}
                            <select defaultValue={loadedUser.difficulty} name="difficulty" id="difficulty" className='pl-2 w-32 bordered border-violet-300'>
                        ...
                        <div className='flex gap-10 lg:flex-row md:flex-row flex-col'>
                            ...
                            <DatePicker defaultValue={loadedUser.startDate} className='pl-4 lg:w-64 py-1 bordered border-violet-300' selected={startDate} onChange={(date) => setStartDate(date)} />
                        </div>
                        ...
                        <div className="form-control">
                            ...
                            <input defaultValue={loadedUser.discription} type="text" name="description" placeholder="Short description" className="input lg:w-96 w-auto h-20" required />
                            </label>
                        </div>
                    </div>
                   <div className="pb-5">
                    <input type="submit" value='Update Assignment' className="py-3 bg-violet-500 text-white px-8 rounded-lg font-bold mt-8"/>
                    </div>          
                </div>
                </form>
            </div>
